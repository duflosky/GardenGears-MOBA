...
namespace UI.Menu
{
    public class LobbyUIManager : MonoBehaviourPun
    {
        ...
        [Header("Selection Part")] [SerializeField] private Button readyButton;
        ...
        public void Initialization()
        {
            ...
            // Default if the player not select any champion
            currentChampion = 2;
        ...
        {
            photonView.RPC("ShowRPC", RpcTarget.MasterClient, PhotonNetwork.LocalPlayer.ActorNumber, (byte)currentTeam, currentChampion, isReady);
        }
